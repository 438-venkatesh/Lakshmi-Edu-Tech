        ...
        <div className="flex justify-between lg:items-start items-center flex-col lg:flex-row gap-3 w-full">
          ...
          <div className="text-center flex flex-col sm:flex-row ">
            <div className="flex ">
              ...
              <Link to='https://github.com/438-venkatesh' target="__blank" className="text-white hover:underline mr-1"
              >
                Venkatesh Ponnuru
              </Link>
            </div>
            <span> © 2025 Lakshmi Edu-Tech</span>
          </div>

          <div className="flex items-center">
            <a href="www.linkedin.com/in/
venkatesh-ponnuru-797913279
" className="text-white p-3 hover:bg-richblack-700 rounded-full duration-300" target="_blank" rel="noopener noreferrer">
              <ImLinkedin2 size={17} />
            </a>
            <a href="https://www.github.com/438-venkatesh" className="text-white p-3 hover:bg-richblack-700 rounded-full duration-300" target="_blank" rel="noopener noreferrer">
              <ImGithub size={17} />
            </a>
          </div>
